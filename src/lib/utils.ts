...
const flatten = <T extends Record<string, unknown>>(data: object, prefix: string = "") => {
...
// biome-ignore lint/suspicious/noExplicitAny: needed for this generic utility function
