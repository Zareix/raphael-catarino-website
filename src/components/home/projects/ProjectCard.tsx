  ...
  return (
    ...
    >
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="border-b-none fixed bottom-0 z-50 mx-[-1px] flex h-full max-h-[95%] flex-col rounded-t-[10px] border border-gray-200 sm:left-[calc(50%-250px)]">
          <div className="mx-auto flex flex-1 flex-col overflow-hidden rounded-t-[10px] bg-stone-50 p-4 sm:max-w-[500px] dark:bg-slate-900">
            <Drawer.Close
