...
export const SkillsSelector = ({ domains }: SkillsSelectorProps) => {
  const [selectedDomainName, setSelectedDomainName] = useState<string>(Object.keys(domains)[0])
    ...
    <div className="flex h-62.5 w-full flex-col gap-4">
        ...
        {Object.keys(domains).map((domain) => (
          <li
            ...
            className={
              ...
              (selectedDomainName === domain ? " bg-gray-300/30 dark:bg-slate-400/20" : "")
            }
          >
      ...
      <div className="relative grid justify-center">
        {Object.entries(domains).map(([domain, skills]) => (
          ...
          >
            {skills.map((skill) => (
              <div className="relative grid justify-items-center text-center" key={skill}>
